...
function Thumb({
  ...
  if (!motion) {
    ...
    const common = { alt: "", width: 800, height: 450, loading: "lazy", decoding: "async" } as const;
    return (
      <>
        <img src={p.preview} {...common} data-theme-art={light ? "dark" : undefined} />
        {light && <img src={light} {...common} data-theme-art="light" />}
      </>
    );
  }
  return (
