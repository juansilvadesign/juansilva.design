...
const corsOptions = {
  origin: process.env.NODE_ENV === 'production'
    ? [
        // Current production origin — was missing, so every form submit from the
        // live site failed the CORS preflight.
        'https://juanpablosilva.com.br',
        'https://www.juanpablosilva.com.br',
        // Target domain, not bought yet — kept so the cutover needs no server change.
        'https://juansilva.design',
        'https://www.juansilva.design',
      ]
    : 'http://localhost:3000',
  methods: ['POST'],
