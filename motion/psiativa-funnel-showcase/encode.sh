...
echo "=== 1. Extracting poster frame at 3.0s (settled hero) ==="
ffmpeg -y -ss 00:00:03.000 -i "${S}.mp4" -vframes 1 "${OUT_DIR}/${NAME}.poster-source.png"
